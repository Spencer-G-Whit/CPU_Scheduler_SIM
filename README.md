# CPU_Scheduler_SIM
# Project for OS
## Text from SIM_PROJECT_Assignment.docx
```
...
Deliverables March 18:  Part A
•	System design documents
Deliverables March 25:
•	Walkthrough/Demonstration of your simulation model with informal discussion of your findings
...
Multiprocessor Distribution Assignment:
     Choose one of the 4 approaches described in Ch 10 to design and implement. You are to consider issues associated with multiprocessor processing.
NOTE:  Remember this is a model. Though you are representing multicores, you need not multithread the application for each core. If you see an opportunity to improve your simulation model with multithreads, go for it (but it is not required).
...
o	Implement time quantums as discrete events, advanced by the designated block of time, NOT a continuous interval clock module.
...
Part B: Code Review (45 points)
45 points
Respond carefully to the questions given for the code review																						
...
Part D: Group Benchmarking Analysis Report  (15 points)    
       15 points	Graphs of T, W, and R;  
Throughput for sample time frames
Statement of Assumptions    

Part E:  Individual  Writeup   (10 points)
